...
[![Version](https://img.shields.io/badge/version-1.63.0-blue.svg)](#install)
...
```bash
sf package install --package 04tal000006qZmEAAU --wait 10 --target-org <your-org>
```

[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tal000006qZmEAAU) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tal000006qZmEAAU)
...
|---------|---------|------------|
| v1.63.0 | **Latest (Released)** | `04tal000006qZmEAAU` |
