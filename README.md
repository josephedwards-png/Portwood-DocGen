...
[![Version](https://img.shields.io/badge/version-1.59.0-blue.svg)](#install)
...
[Install in Production](https://login.salesforce.com/packaging/installPackage.apexp?p0=04tal000006lrDVAAY) | [Install in Sandbox](https://test.salesforce.com/packaging/installPackage.apexp?p0=04tal000006lrDVAAY)
...
|---------|---------|------------|
| v1.59.0 | **Latest (Released)** | `04tal000006lrDVAAY` |
